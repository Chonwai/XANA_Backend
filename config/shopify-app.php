...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'X Home'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_orders,write_orders,read_all_orders,read_customers,write_customers,read_product_listings'),
    ...
    */
    ...
    'myshopify_domain' => env('SHOPIFY_MYSHOPIFY_DOMAIN', 'chonwaix.myshopify.com'),
